...
## Project Structure
    ...
    ├── long_snowflake_dev_62368  # Django project configurations
...
1. Clone this repo and `cd long_snowflake_dev_62368`
...
2. Clone this repo and `cd long_snowflake_dev_62368`
